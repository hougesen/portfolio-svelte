<section id="contact" class="grid grid-cols-1 lg:grid-cols-2 items-center">
    <div class="flex flex-col gap-1">
        <h2 class="lowercase text-4xl lg:text-5xl font-bold mb-2">Wanna get in touch?</h2>

        <p class="text-xl">I am always available for exciting discussions</p>
        ...
        <div class="flex items-center gap-2">
            ...
            <p class="text-xl">Odense, Danmark</p>
        </div>
    </div>

    <svg
        class="w-full max-w-[16rem] h-fit text-black dark:text-white lg:block hidden mx-auto"
        viewBox="0 0 629 605"
